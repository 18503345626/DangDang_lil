...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/user/registerOk" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<h4>
						第二步：输入激活码<span class="red">${activeCode}</span>
					</h4>
					<div class="mess">
						...
						<span id="errorMsg" class="no_right">${message}</span>
					</div>
				</div>
			</div>
		</form>
