...
<script type="text/javascript">
   function updateCart(id){
        var num=$("#"+id).val();
        if(num>0){
          window.location.href="${pageContext.request.contextPath}/cart/updateCart?bookId="+id+"&count="+num;
        }  
    } 
</script>
			...
			<div class="choice_bord">
				...
				<c:forEach items="${sessionScope.cart}" var="map">
					...
					<tr class='td_no_bord'>
						...
						<td>
							<a href="${pageContext.request.contextPath}/cart/deleteCart?bookId=${map.key}">删除</a>
						</td>
					</tr>
			</c:forEach>
				</table>
				...
				<div class="choice_balance">
					...
					<div class="total_balance">
						<div class="save_total">
							您共节省：
							<span class="c_red"> ￥${sessionScope.save}<span id="total_economy"></span></span>
							<span style="font-size: 14px">|</span>
							<span class="t_add">商品金额总计：</span>
							<span class="c_red_b">￥${sessionScope.total}<span id='total_account'></span>
							</span>
						</div>
