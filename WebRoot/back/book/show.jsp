  ...
  <body style="background-color: #f0f9fd;">
  	...
  	<div style="margin: 0 auto;text-align:center;">
  		<form action="${pageContext.request.contextPath}/book/selectByKey" method="post">
  			<input onclick="location.href='${pageContext.request.contextPath}/category/selectAllSecond'" class="button btn-p" value="添加图书&raquo;" />&emsp;&emsp;
  	...
  	<table bordercolor='#898E90' align='center' border='3px' cellpadding='5px' cellspacing="0px" >
  		...
  		<c:forEach items="${list}" var="book">
			<tr align='center'>
				...
				<td>${book.stock}</td>
				<td>
					<input  class="button"  onclick="location.href='${pageContext.request.contextPath}/book/selectOneById?bookId=${book.book_id}'" value="修改 " />
					<input class="button-del" onclick="location.href='${pageContext.request.contextPath}/book/deleteOne?bookId=${book.book_id}'" value="删除 " />
				</td>
			</tr>
		</c:forEach>
